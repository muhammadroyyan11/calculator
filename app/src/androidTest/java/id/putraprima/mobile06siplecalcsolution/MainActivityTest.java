...
public class MainActivityTest {
    ...
    public void mainActivityTest() {
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.edit_text_angka_pertama), withText("2"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.edit_text_angka_pertama), withText("20"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.edit_text_angka_kedua), withText("5"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
